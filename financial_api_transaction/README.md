...
```bash
git clone https://github.com/Glaucobas/financial_api_transaction.git
```
...
```bash
flask run --host 0.0.0.0 --port 5006 --reload
```
...
```bash
docker build -t financial_api_transaction .
```

### **3. Executar o Container**
Para rodar o container criado:
```bash
docker run -d -p 5006:5000 --name financial_api_transaction financial_api_transaction
```
